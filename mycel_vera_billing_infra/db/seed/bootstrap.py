...
PERMISSIONS = [
    ...
    ("read", "agency", "Read agency records"),
    ("write", "agency", "Create/update/delete agency records"),
    ("read", "charges", "Read charges records"),
    ("write", "charges", "Create/update/delete charges records"),
    ("read", "commission", "Read commission records"),
    ("write", "commission", "Create/update/delete commission records"),
    ("read", "invoice", "Read invoice records"),
    ("write", "invoice", "Create/update/delete invoice records"),
    ("read", "payments", "Read payments records"),
    ("write", "payments", "Create/update/delete payments records"),
    ("read", "policy_lifecycle", "Read policy lifecycle records"),
    ("write", "policy_lifecycle", "Create/update/delete policy lifecycle records"),
]

ROLES = {
    "mycel_vera_billing_reader": {
        "description": "Read-only access to mycel_vera_billing data",
        "filter": lambda a, r: a == "read",
    },
    "mycel_vera_billing_writer": {
        "description": "Full CRUD access to mycel_vera_billing data",
...
async def seed_rbac():
    ...
    print(f"  RBAC seed complete for mycel_vera_billing")


if __name__ == "__main__":
    print(f"\n=== RBAC Bootstrap: mycel_vera_billing ===")
